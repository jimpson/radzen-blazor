...
namespace Radzen
{
    ...
    public static class QueryableExtension
    {
        ...
        {
            Func<CompositeFilterDescriptor, bool> canFilter = (c) => dataFilter.columns.Where(col => col.Property == c.Property).FirstOrDefault()?.FilterPropertyType != null &&
        ...
        private static void AddWhereExpression<T>(Func<CompositeFilterDescriptor, bool> canFilter, CompositeFilterDescriptor filter, ref Dictionary<string, IEnumerable<object>> whereList, ref int index, RadzenDataFilter<T> dataFilter)
        {
            ...
            else
            {
                ...
                var column = dataFilter.columns.Where(c => c.Property == filter.Property).FirstOrDefault();
